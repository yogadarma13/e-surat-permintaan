...
class DetailHistoryAdapter(var dataItemHistory: List<ItemsDetailHistory>):
    RecyclerView.Adapter<BaseViewHolder<ItemsDetailHistory>>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): BaseViewHolder<ItemsDetailHistory> {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<ItemsDetailHistory>, position: Int) {
